...
<body>
    ...
    <section class="far3-us">
    <h1>Contact Us</h1>

        <p class="lead">Send us any problems facing with our organization </p>
        ...
        <div class="row">
            <div class="far3-col">
                <div>
                    ...
                    <span>
                        <h5>Spintex Road, ABC Building</h5>
                        <p>Plot C11 Tetteh Quarshie Interchange, Spintex Rd, Accra</p>
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <span>
                        <h5>gwsc@gmail.com</h5>
                        <p>Email us your query</p>
                    </span>
                </div>
            </div>

            <form id="far3-form" method="post" action="tact.php" role="form">
